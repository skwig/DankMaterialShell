        ...
        Row {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    StyledText {
                        text: BatteryService.isCharging ? I18n.tr("Charge Rate") : I18n.tr("Power Draw")
                    ...
                    StyledText {
                        text: BatteryService.changeRate > 0.05 ? `${BatteryService.changeRate.toFixed(1)} W` : I18n.tr("Unknown")
