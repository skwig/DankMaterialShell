...
DankModal {
    ...
    layerNamespace: "skwig:generic-picker"
    ...
    function openPicker(inputText: string, requestId: string, completionHandler): string {
        pickerController.searchQuery = "";
        pickerController.load(inputText, requestId, completionHandler);
        open();
        return "PICKER_OPEN_SUCCESS";
    }
